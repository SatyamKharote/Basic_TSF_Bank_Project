      ...
      <div id="carouselDarkVariant" class="carousel slide carousel-dark" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="bank4.jpg" alt="Loading Image..">
            <div class="centered">
            <h1>Welcome to The <span>Sparks Foundation Bank</span></h1>
                <button type="button" id="join" class="btn btn-warning">JOIN NOW</button>
             </div>
            </div>

          <div class="carousel-item ">
            <img src="bank3.jpg" alt="Loading Image..">
            <div class="centered1">
                <h1>GET YOUR <span>LOAN NOW</span></h1>
                <h4> 2 years interest </h4>
            </div>
          </div>
        </div>
